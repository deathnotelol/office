    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12 col-xxl-12">
                <form action="{{ route('inventoryCat.update', $inventoryCategory->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            value="{{ old('inventoryCatName', $inventoryCategory->inventoryCatName) }}"
                                            >
                                        ...
                                        <div class="form-group">
                                            ...
                                            value="{{ old('inventoryCatRemark', $inventoryCategory->inventoryCatRemark) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
