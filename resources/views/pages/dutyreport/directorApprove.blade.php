...
<div class="content-body">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            {{-- <div class="row">
                <div class="col-6">
                    ...
                    <div class="card-body">
                        <img src="{{ asset('storage/' . $temporaryReports->transferSignature) }}" alt="Transfer Signature"
                ...
                <div class="col-6">
                    ...
                    <div class="card-body">
                        <img src="{{ asset('storage/' . $temporaryReports->receiverSignature) }}" alt="Transfer Signature"
                            style="width: 200px; height: 200px;">
                    </div>
                    <div class="card-body text-dark text-wrap text-lg">
                        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <div class="card-body d-flex justify-content-center align-items-center">                
                        <img src="{{ asset('public/storage/' . $temporaryReports->transferSignature) }}" alt="Transfer Signature" class="w-100">
                    </div>
                    <div class="card-body text-dark text-wrap text-lg">
                        <div class="row">
                            <div class="col-6">
                ...
                <div class="col-6">
                    ...
                    <div class="card-body d-flex justify-content-center align-items-center">
                        <img src="{{ asset('public/storage/' . $temporaryReports->receiverSignature) }}" alt="Transfer Signature" class="w-100">
                    </div>
                    <div class="card-body text-dark text-wrap text-lg">
                        <div class="row">
                            <div class="col-6">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card-body d-flex justify-content-left align-items-left">
                        <p>{{ $temporaryReports->ddRemark }}</p>
                    </div>
                    <div class="card-body d-flex justify-content-center align-items-center w-50">
                        <img src="{{ asset('public/storage/' . $temporaryReports->ddSignature) }}" alt="Transfer Signature" class="w-100" width="200px" height="200px">
                    </div>
                    <div class="card-body text-dark text-wrap text-lg">
                        <div class="row">
                            <div class="col-3">
        ...
        @if (auth()->user()->hasRole(['director']))
            <form action="{{ route('temporary-duty-report.updateDirectorApprove', $temporaryReports->id) }}"
                method="POST">
                @csrf
                @method('PUT')
                <div class="card">
                    ...
                    <div class="col-12 p-3">
                        <div class="form-group">
                            ...
                            value="{{ old('directorRemark', $temporaryReports->directorRemark) }}"> {{ old('directorRemark', $temporaryReports->directorRemark) }}</textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-4">
                            <div class="form-group p-3">
                                ...
                                <div>
                                    ...
                                    <canvas id="directorSign" class="border w-100" width="300"
                                        height="200"></canvas>
                                    <button type="button" class="btn btn-primary btn-sm mt-2"
                                        onclick="clearCanvas('directorSign')">Clear</button>
                                </div>

                                <!-- Hidden input to store the signature data -->
                                <input type="hidden" name="directorSignature" id="directorSignature" value="">

                                @if ($signature)
                                    <!-- Pass existing signature URL to JavaScript -->
                                    <script>
                                        window.onload = function() {
                                            const signatureCanvas = document.getElementById('directorSign');
                        ...
                        <div class="col-8">
                            <div class="form-group p-3">
                                ...
                                <input class="form-control form-control-lg" type="text" id="transferPerson"
                                    ...
                                    value="{{ old('directorNumber', $temporaryReports->directorNumber) }}">
                            </div>
                            <div class="form-group p-3">
                                ...
                                <input class="form-control form-control-lg" type="text" id="transferRank"
                                    ...
                                    value="{{ old('directorRank', $temporaryReports->directorRank) }}">
                            </div>
                            <div class="form-group p-3">
                                ...
                                <input class="form-control form-control-lg" type="text" id="transferName"
                                    ...
                                    value="{{ old('directorName', $temporaryReports->directorName) }}">
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function clearCanvas(canvasId) {
        ...
        document.getElementById('directorSignature').value = ''; // Clear hidden input
    }
    ...
    function saveSignature(canvasId) {
        ...
        document.getElementById('directorSignature').value = signatureDataUrl;
    }

    // Optionally call saveSignature before form submission
    document.querySelector('form').addEventListener('submit', function() {
        saveSignature('directorSign');
    });
</script>
