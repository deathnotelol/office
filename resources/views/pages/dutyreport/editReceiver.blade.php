    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12 col-xxl-12">
                <form action="{{ route('temporary-duty-report.updateReceiver', $temporaryReports->id) }}"
                    method="POST">
                    @csrf
                    @method('PUT')
                    @if (auth()->user()->hasAnyRole(['super-admin', 'officer']))
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <h3 class="text-warning text-center">အထက်တွင်ဖြည့်သွင်းထားသော အချက်အလက်များ မှန်ကန်မှုရှိ/ မရှိ စိစစ်ပြီးမှလက်ခံပေးရန် ဖြစ်ပါသည်။</h3>
                                        </div>
                                        <div class="col-6">
                                            <div class="card-header">
