...
// Assuming this part of the code handles the selection of multiple files
if (isset($_POST['selectedFiles'])) {
    $filePaths = $_POST['selectedFiles']; // Example: ['file1.jpg', 'file2.jpg']

    // Call the function to send the file paths to the opener window
    sendFilePathsToOpener($filePaths);
}

function sendFilePathsToOpener($filePaths)
{
    // Generate a script to send the file paths back to the opener (parent window)
    echo "<script>
            window.opener.selectFiles(" . json_encode($filePaths) . ");
            window.close();
          </script>";
}
...
// $root_path = __DIR__ . '/../storage/app/public/uploads';

// FileManager Configuration
$root_path = '/var/www/html/office/storage/app/public/caseFiles/';
$root_url = '/office/storage/app/public/caseFiles/';
$thumbs_base_path = $root_path . 'thumbs/';

// Base settings for FileManager
    ...
    <div class="row">
        <div class="col-12">
            <ul class="list-group w-50 my-3" data-bs-theme="<?php echo FM_THEME; ?>">
                ...
                <li class="list-group-item"><strong>File size:</strong>
                ...
                <ul class="navbar-nav justify-content-end" data-bs-theme="<?php echo FM_THEME; ?>">
                    ...
                    <?php if (FM_USE_AUTH): ?>
                        <li class="nav-item avatar dropdown">
                            ...
                            <div class="dropdown-menu text-small shadow" aria-labelledby="navbarDropdownMenuLink-5"
                                data-bs-theme="<?php echo FM_THEME; ?>">
                                <?php if (!FM_READONLY): ?>
